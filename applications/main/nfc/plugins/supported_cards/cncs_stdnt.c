...
} __attribute__((packed)) StdntData;

static const MfClassicKeyPair stdnt_keyset_v0[] = {
    ...
    {.a = 0x000000000000, .b = 0x4bb911b0abf3}, {.a = 0x000000000000, .b = 0x8f5ddc4d20d7},
...
static const MfClassicKeyPair stdnt_keyset_v1[] = {
...
static const MfClassicKeyPair stdnt_keyset_v2[] = {
    {.a = 0xa0a1a2a3a4a5, .b = 0xb0b1b2b3b4b5}, {.a = 0x000000000000, .b = 0x7ddf9e3f4020},
...
static const MfClassicKeyPair stdnt_keyset_v3[] = {
    {.a = 0xa0a1a2a3a4a5, .b = 0xb0b1b2b3b4b5},
    {.a = 0x000000000000, .b = 0x7ddf9e3f4020},
    {.a = 0xa0a1a2a3a4a5, .b = 0xb0b1b2b3b4b5},
    {.a = 0xa0a1a2a3a4a5, .b = 0xb0b1b2b3b4b5},
    ...
    {.a = 0xffffffffffff, .b = 0xffffffffffff},
    {.a = 0x000000000000, .b = 0x2b780f1ed75b},
    {.a = 0x000000000000, .b = 0xf7a65799c6ee},
    {.a = 0x26973ea74321, .b = 0xd27058c6e2c7},
    {.a = 0xeb0a8ff88ade, .b = 0x578a9ada41e3},
    {.a = 0x000000000000, .b = 0x3546315121c0},
    {.a = 0x000000000000, .b = 0x4bf04d117ed5},
...
static const MfClassicKeyPair stdnt_keyset_v4[] = {
...
static const MfClassicKeyPair stdnt_keyset_v5[] = {
    {.a = 0xa0a1a2a3a4a5, .b = 0xb0b1b2b3b4b5},
    {.a = 0x3d206ca92814, .b = 0x245534783842},
    {.a = 0x2ea63e94b464, .b = 0x36307f716f1a},
    {.a = 0xdf8ef4313010, .b = 0x2bd90c39091e},
...
static const MfClassicKeyPair stdnt_keyset_v6[] = {
    {.a = 0xa0a1a2a3a4a5, .b = 0xb0b1b2b3b4b5},
    {.a = 0xffffffffffff, .b = 0xffffffffffff},
    {.a = 0xffffffffffff, .b = 0xffffffffffff},
    {.a = 0xffffffffffff, .b = 0xffffffffffff},
...
static const MfClassicKeyPair stdnt_keyset_v7[] = {
...
static const MfClassicKeyPair stdnt_keyset_v8[] = {
    {.a = 0xa0a1a2a3a4a5, .b = 0xb0b1b2b3b4b5}, {.a = 0xffffffffffff, .b = 0xffffffffffff},
    {.a = 0xa0a1a2a3a4a5, .b = 0xb0b1b2b3b4b5}, {.a = 0xa0a1a2a3a4a5, .b = 0xb0b1b2b3b4b5},
    {.a = 0xe56ac127dd45, .b = 0x19fc84a3784b}, {.a = 0x77dabc9825e1, .b = 0x9764fec3154a},
    {.a = 0xffffffffffff, .b = 0xffffffffffff}, {.a = 0x2066f4727129, .b = 0xf7a65799c6ee},
...
static bool stdnt_verify(Nfc* nfc) {
    ...
    bit_lib_num_to_bytes_be(stdnt_keyset_v1[15].a, sizeof(MfClassicKey), mf_key.data);
    if(mf_classic_poller_sync_auth(nfc, sec15_block, &mf_key, key_type, NULL) !=
       MfClassicErrorNone) {
        bit_lib_num_to_bytes_be(stdnt_keyset_v4[15].a, sizeof(MfClassicKey), mf_key.data);
        if(mf_classic_poller_sync_auth(nfc, sec15_block, &mf_key, key_type, NULL) !=
           MfClassicErrorNone)
            return false;
    }
    ...
    if(b60_type == 0x03) {
        if(block_data.data[0] == 0 || block_data.data[2] == 0) return false;
    } else if(b60_type == 0x01) {
        if(block_data.data[0] != 0x26 || block_data.data[1] != 0x05) return false;
    } else {
        return false;
    }
...
static bool stdnt_read(Nfc* nfc, NfcDevice* device) {
    furi_assert(nfc);
    furi_assert(device);
    ...
    do {
        ...
        const MfClassicKeyPair* keysets_1k[] = {
            stdnt_keyset_v1, stdnt_keyset_v3, stdnt_keyset_v4, stdnt_keyset_v5, stdnt_keyset_v6};
        const MfClassicKeyPair* keysets_4k[] = {
            stdnt_keyset_v0, stdnt_keyset_v2, stdnt_keyset_v7, stdnt_keyset_v8};
        size_t num_keysets = (type == MfClassicType1k) ? 5 : 4;
...
static bool stdnt_parse(const NfcDevice* device, FuriString* parsed_data) {
    furi_assert(device);
    const MfClassicData* data = nfc_device_get_data(device, NfcProtocolMfClassic);
    bool parsed = false;
    StdntData ticket_data = {0};
    ...
    if(key_a != stdnt_keyset_v1[8].a) return false;

    // Reject BEPK cards: sector 15 key A is 0xffffffffffff on BEPK, student keys differ
    ...
    // Positive student identification: verify b60_type and block61 signature
    const uint8_t b60_type = data->block[60].data[0];
    if(b60_type == 0x01) {
        if(data->block[61].data[0] != 0x26 || data->block[61].data[1] != 0x05) return false;
    } else if(b60_type == 0x03) {
        if(data->block[61].data[0] == 0 || data->block[61].data[2] == 0) return false;
    } else {
        return false;
    }
    ...
    // block[33]: doc-series + number (pack 8-byte id_info, skip space at data[5] and data[8])
    ...
    // block[52]: surname CP1251 (skip 0x21 prefix at data[0], stop at first 0x20)
    {
        size_t i = 1;
        size_t len = 0;
    ...
    // blocks[56-57]: name + patronymic CP1251 (skip 0x6E prefix at data[0])
    // block56 layout: [0x6E] [name...] [0x20] [patronymic...] (may continue into block57)
    // patronymic ends at the next 0x20, which can be in block56 or block57
    {
        const uint8_t* raw = data->block[56].data;
        size_t i = 1;
        size_t len = 0;

        // extract name: from byte 1 to first 0x20
        while(i < sizeof(data->block[56].data) && raw[i] != 0x20) {
            ticket_data.name[len++] = raw[i++];
        }
        ticket_data.name[len] = 0;

        // skip the 0x20 space delimiter between name and patronymic
        while(i < sizeof(data->block[56].data) && raw[i] == 0x20)
            i++;

        // extract patronymic: starts in block56, may continue into block57
        len = 0;
        while(i < sizeof(data->block[56].data) && raw[i] != 0x20) {
            ticket_data.patronymic[len++] = raw[i++];
        }
        // if patronymic reached end of block56, continue reading block57
    ...
    // Allocate FuriStrings for elsytools output
    ...
    // Card number from UID (plantain procedure)
...
static const NfcSupportedCardsPlugin stdnt_plugin = {
...
__attribute__((used)) const FlipperAppPluginDescriptor* cncs_stdnt_plugin_ep() {
    static const FlipperAppPluginDescriptor plugin_descriptor = {
        .appid = NFC_SUPPORTED_CARD_PLUGIN_APP_ID,
        .ep_api_version = NFC_SUPPORTED_CARD_PLUGIN_API_VERSION,
        .entry_point = &stdnt_plugin,
    };
